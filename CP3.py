...
class Test(unittest.TestCase):
    ...
    def test_login3(self):
        self.user=self.driver.find_element(By.XPATH,"//input[@name='username']").send_keys("")
        self.password=self.driver.find_element(By.XPATH,"//input[contains(@type,'password')]").send_keys("")
